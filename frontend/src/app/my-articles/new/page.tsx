        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">اكتب مقالك وارسله للمراجعة</p>
            </div>
            <Link
              href="/my-articles"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                maxLength={500}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                placeholder="وصف مختصر للمقال (حد أقصى 500 حرف)"
              />
            ...
            <div className="flex items-center space-x-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
                <span className="text-sm font-medium text-gray-700">إرسال للمراجعة والنشر</span>
              </label>
              <p className="text-xs text-yellow-700">سيتم مراجعة المقال من قبل الإدارة قبل النشر</p>
            </div>
            ...
            <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
              ...
              >
                {loading ? 'جاري الحفظ...' : formData.isPublished ? 'إرسال للمراجعة' : 'حفظ كمسودة'}
              </button>
            </div>
          </form>
        </div>
